...
ID	商品名	出品者	購入者	いいね/コメ数	テストの狙い・確認事項
1	腕時計	ユーザー1	-	0 / 0	初期状態（アクションなし）の表示確認
2	HDD	ユーザー1	-	1 / 0	出品者本人による「いいね」の反映確認
3	玉ねぎ3束	ユーザー1	ユーザー2	2 / 0	**売却済み（SOLD）**商品の表示と購入ボタンの無効化
4	革靴	ユーザー1	ユーザー3	0 / 1	購入者による購入前の質問コメント表示
5	ノートPC	ユーザー2	-	0 / 2	複数ユーザーによるコメント投稿のレイアウト確認
6	マイク	ユーザー2	ユーザー1	1 / 1	自分が購入した商品のステータスと過去のアクション確認
7	ショルダーバッグ	ユーザー2	ユーザー3	1 / 1	出品者と購入者間での相互アクション確認
8	タンブラー	ユーザー3	-	2 / 1	自分が行ったいいね・コメントのUI反映（ハートの色等）
9	コーヒーミル	ユーザー3	ユーザー1	1 / 2	購入確定までのやり取り（複数コメント）の再現確認
10	メイクセット	ユーザー3	ユーザー2	2 / 2	全要素（いいね・コメント・SOLD）が揃った状態の確認
