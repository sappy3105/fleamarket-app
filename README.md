...
※出品者と購入者番号は、テスト用アカウントのIDで表示しています。

| ID | 商品名 | 出品者 | 購入者 | 支払い状況 | いいね/コメ数 | いいね/コメした人 | 確認事項 |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :--- |
| 1 | 腕時計 | 1 | - | 支払済 | 0 / 0 | - | 初期状態の確認 |
| 2 | HDD | 1 | - | 支払済 | 1 / 0 | 1/- | 出品者本人による「いいね」の反映確認 |
| 3 | 玉ねぎ3束 | 1 | 2 | 支払済 | 2 / 0 | 2,3 / - | **売却済み（SOLD）**商品の表示と購入ボタンの無効化 |
| 4 | 革靴 | 1 | 3 | 支払い待ち | 0 / 1 | - / 3 | 購入者による購入前の質問コメント表示 |
| 5 | PC | 2 | - | 支払済 | 0 / 2 | - / 1,3 |  複数ユーザーによるコメント投稿のレイアウト確認 |
| 6 | マイク | 2 | 1 | 支払済 | 1 / 1 | 1 / 1 | 自分が購入した商品のステータスと過去のアクション確認 |
| 7 | ショルダーバッグ | 2 | 3 | 支払済 | 1 / 1 | 2 / 3 | 出品者と購入者間での相互アクション確認 |
| 8 | タンブラー | 3| - | 支払済 | 2 / 1 | 1,2 / 1 | 自分が行ったいいね・コメントのUI反映（ハートの色等） |
| 9 | コーヒーミル | 3 | 1 | 支払い待ち | 1 / 2 | 2 / 1,2 | 購入確定までのやり取り（複数コメント）の再現確認 |
| 10 | メイクセット | 3 | 2 | 支払済 | 2 / 2 | 1,2 / 1,2 | 全要素（いいね・コメント・SOLD）が揃った状態の確認 |
