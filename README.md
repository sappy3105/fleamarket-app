...
| ユーザー名 | 認証有無 | メールアドレス | パスワード |
| テストユーザー1 | 認証済み | `test1@example.com` | `password` |
| テストユーザー2 | 未認証・認証メール送信済み | `test2@example.com` | `password` |
| テストユーザー3 | 未認証・認証メール未送信 | `test3@example.com` | `password` |
